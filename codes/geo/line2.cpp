...
struct line2{
	...
	line2(K a, K b, K c) : n(vec2(a, b)), c(-c) {}
	line2(vec2 s, vec2 e) : n(vec2(s.y-e.y, e.x-s.x)), c(det(e,s)) {}
};
...
line2 parallel(line2 l, vec2 p){ return line2(l.n, dot(l.n, p)); }
line2 perp(line2 l, vec2 p){ return line2(perp(l.n), det(l.n, p)); }
